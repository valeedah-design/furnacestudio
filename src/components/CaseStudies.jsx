...
const CASES = [
  {
    ...
    idx: "01",
    name: "EMBER & OAK",
    sector: "Restaurant · Napoli",
    problem: "Full kitchen, empty Tuesdays. The website was a PDF menu from 2019, and nobody could find them on Google.",
    changed: "New identity, a one-page site built to load in under a second, the Google profile rebuilt, booking in two taps.",
  ...
  },
  {
    ...
    sector: "Barbershop · Milano",
    problem: "Walk-ins only. Chairs empty midweek, weekends pure chaos, and no way to plan around either.",
    changed: "A booking flow, local SEO, and photo direction that actually looks like the cut you get in the chair.",
  ...
  },
  {
    ...
    sector: "Clinic · Torino",
    problem: "A website from another decade. Phones quiet. Trust quieter. Referrals doing all the work alone.",
    changed: "Rebrand, a 1.1-second website, one clear call to action on every page, no jargon anywhere.",
    result: "The diary filled. Referrals started mentioning the website by name.",
    metrics: [
...
const STORY_ROWS = [
  ...
  { label: "WHAT WE CHANGED", key: "changed", tone: "white" },
  { label: "WHAT CAME OUT", key: "result", tone: "temper" },
];
    ...
    <article data-testid={`case-${c.slug}`} className="border-t border-white/10 py-12 md:py-16">
      ...
      <div className="mt-8 md:mt-10">
        ...
        <p className="mt-3 text-[10px] font-bold uppercase tracking-[0.3em] text-white/30">
          Drag the handle — before on the left, after on the right
        </p>
      </div>
  ...
  return (
    ...
    >
      ...
      <h2 className="text-[clamp(2.4rem,7vw,7rem)] font-extrabold uppercase leading-[0.95] tracking-[-0.02em]">
        <MaskedLine>Fresh out of</MaskedLine>
        <MaskedLine delay={0.12}>
          the <span className="text-outline">furnace.</span>
        </MaskedLine>
      </h2>
